...
public class Scrabble {
	...
	public static int wordScore(String word) {
		int score = 0;
		String wordLowCase = MyString.lowerCase(word);

		for (int i = 0; i < word.length(); i++) {
			score += SCRABBLE_LETTER_VALUES[wordLowCase.charAt(i)-97];
		}
	...
	public static String createHand() {
		String hand = MyString.randomStringOfLettersScrabbel(HAND_SIZE-2);
